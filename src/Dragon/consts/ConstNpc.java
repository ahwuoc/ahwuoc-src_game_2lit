...
public class ConstNpc {
    ...
    public static final String HUONG_DAN_BLACK_BALL_WAR = "Mỗi Ngày Từ 8H Tối Đến 9H Tối, Các Map Omega Sẽ Rơi Ngọc Rồng Sao Đen\n"
            + "Người Nào Tìm Thấy Trước Và Giữ Nó Trong 5 Phút Sẽ Nhận Được Quà Ngẫu Nhiên\n"
            + "Hãy Chiến Đấu Với Các Người Chơi Khác Để Nhặt Nó\n"
            + "Các Ngọc Rồng Sao Đen Sẽ Tương Ứng Với Các Phần Thưởng Giá Trị\n"
            + "Hãy Chiến Đấu Hết Mình Để Dành Được Những Phẩn Thưởng Thích Đáng!\n"
            + "Chúc Bạn May Mắn!\n";
    ...
    public static final byte THIT = 66;
    ...
    public static final byte DO_DO_DO = 95;
    ...
    public static final byte LUYENDUOCSU = 78;
    ...
    public static final byte HANG_NGA = 88;
    public static final byte CAY_LONG_DEN = 89;
    public static final byte TRUNK = 104;
    public static final byte BARDOCK = 70;
    public static final byte HUONGDANNROTUONGLAI = 105;
    public static final byte TIENSI = 106;
    public static final byte THUONGNHAN = 107;

    // ------------------------------------------------------------CAUCA Phước NPC
    public static final byte CHUBE = 90;
    ...
    // hướng dẫn phước
    public static final int HUONG_DAN_1 = 48564;
    public static final int HUONG_DAN_2 = 48565;
    public static final int HUONG_DAN_3 = 48566;
    public static final int HUONG_DAN_4 = 48567;
    public static final int HUONG_DAN_5 = 48568;
    ...
    public static final int phuocdanhsachboss = 542;
    public static final int phuoccapsule = 543;
    public static final int MENU_SELECT_MAP = 545;
    public static final int THANBIMENU = 546;
    public static final int THANBIMENU1 = 547;
}
